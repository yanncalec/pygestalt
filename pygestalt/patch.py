...
def generate_image_foreground(Ps:ArrayLike, Xs:ArrayLike, Hs:ArrayLike, *, N:int, ng:int=10, pfunc:callable) -> ArrayLike:
    """Generate a pixel image of random oriented patches, with tangent direction computed from foreground points.

    Args:
        P: position of balls in the square [0,1]x[0,1], of shape ?x2
